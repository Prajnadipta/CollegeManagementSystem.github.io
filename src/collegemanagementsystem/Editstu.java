...
public class Editstu extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String dept=sd.getText();
        String year=sy.getText();
        ...
        try{
            ...
            String sql="update `stureg` SET `name`='"+name+"',`fname`='"+fname+"',`department`='"+dept+"',`year`='"+year+"',`fatherphone`='"+fnum+"',`phone`='"+pnum+"'WHERE id = '"+id+"'";
